...
Boton botones[] = {
    Boton(26, 1, "Boton1_LED1"),
    Boton(27, 2, "Boton2_LED2"),
    Boton(14, 3, "Boton3_LED3"),
    Boton(2,  4, "Boton4_LED4"),
    Boton(12, 5, "Boton5_LED5"),
    Boton(25, 6, "Boton6_LED6"),
    Boton(32, 7, "Boton7_LED7"),
    Boton(33, 8, "Boton8_LED8")
};
